...
1.  VirtualBoxの起動方法がわからず（スタートにつくらなかった）再インストールしたらKaliが残っていた。  
    ただ、Kali起動中エラーが出て停止してしまった。  
    Kaliの解凍フォルダも、解凍当初と構成が異なっていた（.vdiが無くなっていた）。
    PCを再起動してKaliも別の場所に解凍して、.vboxを実行したら起動できた。  
    これに30分くらい費やした…。
...
1. 調べたこと追記  
   [2024年12月2](/調べたこと/2024年12月2.md)
2. jsはHTMLの操作という頭があったのでファイル操作ができることを知らなかった。（作成とか）
3. ブラウザでGithubを開いているときに「.」を押すとエディターモードになる。  
   左上のメニューから「レポジトリに進む」で元の表示のタブが開く
...
1. 調べたこと追記  
   [2024年12月2](/調べたこと/2024年12月2.md)
2. 目次追記  
   [2024年12月](/調べたこと/2024年12月.md)

## 2024/12/15

1. 調べたこと追記  
   [2024年12月](/調べたこと/2024年12月.md)
2. Apacheはアパッチ（✕あぱっちぇ）、nginxはエンジンエックス（✕えぬじんえっくす）、ubuntuはウブントゥ（✕うぶんちゅ）だった。
3. 読み方がわからないと口頭でのやり取りができないので、読み方を追記。
...
1. htmlやcssのふんわりとした知識の補強のため勉強
2. ネットワークも同上

## 2024/12/06

1. Webサイト勉強のためWebサイトフォルダ作成。  
   [Webサイトフォルダ](/Webサイト/)
2. UATは初めて知った。ペルソナは作成する段階がわかってよかった。
...
2. IDトークンのところでエラー。ポストマンでは正常に取得できることを確認。
...
2. 検索単語の変数化はできた。１サイト分完成。２サイト目も新しいタブで開けた。
